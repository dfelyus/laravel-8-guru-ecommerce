                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if($boy->delivery_boy_status == 1)
                                <a class="btn btn-outline-success" href="{{route('Inactive_Boy',["delivery_boy_id"=>$boy->delivery_boy_id])}}">
                                    <i class="fas fa-arrow-up" title="Click to Inactive"></i>
                                </a>
                            @else
                                <a class="btn btn-outline-info" href="{{route('active_Boy',["delivery_boy_id"=>$boy->delivery_boy_id])}}">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{route('boy_update',["delivery_boy_id"=>$boy->delivery_boy_id])}}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">Boy name:</label>
                                            <input type="text" name="delivery_boy_name" class="form-control" value="{{$boy->delivery_boy_name}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">Phone number:</label>
                                            <input type="number" name="delivery_boy_phone_number" class="form-control" value="{{$boy->delivery_boy_phone_number}}">
                                        </div>
