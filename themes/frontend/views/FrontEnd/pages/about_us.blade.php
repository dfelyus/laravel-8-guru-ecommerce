    ...
    <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="member">
                    <img src="{{$cont->image}}" class="img-fluid" alt="">
                    <div class="member-info">
                        <div class="member-info-content">
                            <h4>{{$cont->first_name}} {{$cont->last_name}}</h4>
                            <span>{{$cont->role}}</span>
                            <div class="social">
                                <a href="{{$cont->link1}}"><i class="icofont-twitter"></i></a>
                                <a href="{{$cont->link2}}"><i class="icofont-facebook"></i></a>
                                <a href="{{$cont->link3}}"><i class="icofont-instagram"></i></a>
                                <a href="{{$cont->link4}}"><i class="icofont-linkedin"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="">
                <div class="col-md-12  align-items-stretch" data-aos="fade-up">
                    <div class="icon-box icon-box-pink">
                        ...
                        <h4 class="title"><u>Our Address</u></h4>
                        <p class="description">{{$set_->address}} <br /> {{$set_->country}}</p>
                    </div>
                </div>
                <div class="col-md-12  align-items-stretch" data-aos="fade-up">
                    <div class="icon-box icon-box-pink">
                        <div class="icon"><i class="bx bx-envelope"></i></div>
                        <h4 class="title"><u>Email Us</u></h4>
                        <p class="description">Email: <br />{{$set_->email}}</p>
                    </div>
                </div>
                <div class="col-md-12  align-items-stretch" data-aos="fade-up">
                    <div class="icon-box icon-box-pink">
                        <div class="icon"><i class="bx bx-phone-call"></i></div>
                        <h4 class="title"><u>Call Us</u></h4>
                        <p class="description">Phone:<br />{{$set_->phone_number}}</p>
                    </div>
                </div>
            </div>
        </div>
