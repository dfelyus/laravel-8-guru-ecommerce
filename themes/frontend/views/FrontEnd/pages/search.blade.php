    ...
    <div class="container">
        <div class="col-md-9 product-w3ls-right">
            ...
            <div class="products-row">
                ...
                @if($dishes_search->count() > 0)
                @foreach($dishes_search as $cateDish)
                    ...
                    <div class="flip-container">
                        <div class="flipper agile-products">
                            ...
                            <div class="back">
                                ...
                                @else
                                <h6>Half :{{$cateDish->half_price}}<sup>TK</sup></h6>
                                @endif
                ...
                <div class="d-flex justify-content-center" style="color: white; margin-top: 20%;">
                    <h2><b>{{$dishes_search->count()}} result(s) found for the search {{request()->input('q')}} !!!</b></h2>
                </div>
                @endif
