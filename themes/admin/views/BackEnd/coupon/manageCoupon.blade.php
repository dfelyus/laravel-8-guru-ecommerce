            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-outline-success" href="{{url('/admin/coupon/InactiveCoupon',$coupon->coupon_id)}}">
                            <i class="fas fa-arrow-up" title="Click to Inactive"></i>
                        </a>
                        @else
                        <a class="btn btn-outline-info" href="{{url('/admin/coupon/activeCoupon',$coupon->coupon_id)}}">
                        ...
                        <a class="btn btn-outline-danger" onclick="return confirm('Delete Coupon ?');" href="{{url('/admin/coupon/delete',$coupon->coupon_id)}}">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{url('/admin/coupon/update',$coupon->coupon_id)}}" method="post">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" required min="0" name="coupon_value" class="form-control" value="{{$coupon->coupon_value}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="recipient-name" class="col-form-label">cart min value:</label>
                                        <input type="number" required min="0" name="cart_min_value" class="form-control" value="{{$coupon->cart_min_value}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="recipient-name" class="col-form-label">Expired on:</label>
                                        <input type="date" required name="expired_on" class="form-control" value="{{$coupon->expired_on}}">
                                    </div>
