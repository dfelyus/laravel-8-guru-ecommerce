                ...
                <div class="card-body">
                    <form action="/admin/coupon/save" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required class="form-control" name="coupon_code" value="{{old('coupon_code')}}">
                        </div>
                        <div class="form-group">
                            <label>Coupon value</label>
                            <input type="number" min="0" required class="form-control" name="coupon_value" value="{{old('coupon_value')}}">
                        </div>
                        <div class="form-group">
                            <label>cart min value</label>
                            <input type="number" required min="0" class="form-control" name="cart_min_value" value="{{old('cart_min_value')}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" required class="form-control" name="expired_on" value="{{old('expired_on')}}">
                        </div>
                        <div class="form-group">
